...
public class DatHang extends AppCompatActivity {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Server.insertdathang, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                if(response.equals("Done")){
                    Toast.makeText(getApplicationContext(), "Đặt hàng thành công", Toast.LENGTH_SHORT).show();
                    finish();
    ...
    private void updateOrder(){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Server.updateorder, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                if(response.equals("Done")){
                    Toast.makeText(getApplicationContext(), "Cập nhật đơn hàng thành công", Toast.LENGTH_SHORT).show();

                }
                else {
                    Toast.makeText(getApplicationContext(), "Cập nhật đơn hàng không thành công", Toast.LENGTH_SHORT).show();
                }
            }
        }, new Response.ErrorListener() {
            @Override
