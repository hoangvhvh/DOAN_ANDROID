...
public class DangKy extends AppCompatActivity {
    ...
    private TextView btnDK, txt_dangnhapdn;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txt_dangnhapdn = findViewById(R.id.txt_dangnhapdn);
        ...
        txt_dangnhapdn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
