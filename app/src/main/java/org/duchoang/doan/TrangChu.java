...
public class TrangChu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener((item) -> {
            ...
            } else if (item.getItemId() == R.id.Click_to_cart) {
                intent = new Intent(this, GioHang.class);
                startActivity(intent);
            } else if (item.getItemId() == R.id.page_3) {
                intent = new Intent(this, DanhSachSP.class);
                startActivity(intent);
            } else if (item.getItemId() == R.id.page_4) {
                intent = new Intent(this, TrangChu.class);
                Toast.makeText(getApplicationContext(), "Tính năng này chưa có", Toast.LENGTH_SHORT).show();
                startActivity(intent);
            } else if (item.getItemId() == R.id.page_5) {
                intent = new Intent(this, ThongTinCaNhan.class);
                startActivity(intent);
            } else {
                Toast.makeText(getApplicationContext(), "Mục này chưa được xử lý", Toast.LENGTH_SHORT).show();
            }
            return true;
        });
