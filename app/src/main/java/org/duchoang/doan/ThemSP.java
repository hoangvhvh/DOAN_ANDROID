...
public class ThemSP extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    private EditText nameproduct,maloai,price,soluong,manhinh,hedieuhanh,cmrsau,cmrtruoc,chip,ram,bonhotrong,sim,pinsac,hinh;
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // hinh = findViewById(R.id.txt_hinh_themdt);
    ...
    public void ThemMoi( ) {
        ...
        String hinh = this.hinh.getText().toString().trim();

        if (nameproduct.equals("") || price.equals("")|| maloai.equals("") || manhinh.equals("") || hedieuhanh.equals("")||cmrsau.equals("")||
                    cmrtruoc.equals("")||chip.equals("")||ram.equals("")||bonhotrong.equals("")||sim.equals("")||pinsac.equals("")||hinh.equals(""))
        {
